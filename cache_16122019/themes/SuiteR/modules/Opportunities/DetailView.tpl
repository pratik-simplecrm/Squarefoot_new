...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.acyualcloseddate_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_ACYUALCLOSEDDATE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{if strlen($fields.acyualcloseddate_c.value) <= 0}
{assign var="value" value=$fields.acyualcloseddate_c.default_value }
{else}
{assign var="value" value=$fields.acyualcloseddate_c.value }
{/if} 
<span class="sugar_field" id="{$fields.acyualcloseddate_c.name}">{$fields.acyualcloseddate_c.value}</span>
{/if}
</div>
</div>
</div>
