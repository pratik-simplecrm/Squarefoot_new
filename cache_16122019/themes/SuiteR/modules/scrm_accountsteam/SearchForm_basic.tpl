...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='1%' >
            ...
            <label for='search_name_basic' >{sugar_translate label='LBL_NAME' module='scrm_accountsteam'}</label>
                    </td>
...
<input type='text' name='{$fields.search_name_basic.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <td scope="row" nowrap="nowrap" width='1%' >
            ...
            <label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='scrm_accountsteam'}</label>
                    </td>
