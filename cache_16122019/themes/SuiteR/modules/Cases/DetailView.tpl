...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.reasonforreschedule_c.hidden}
...
<span class="sugar_field" id="{$fields.reasonforreschedule_c.name|escape:'html'|url2html|nl2br}">{$fields.reasonforreschedule_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
</div>
</div>
</div>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.accountsteam_c.hidden}
...
{if !empty($fields.scrm_accountsteam_id_c.value)}
{capture assign="detail_url"}index.php?module=scrm_accountsteam&action=DetailView&record={$fields.scrm_accountsteam_id_c.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="scrm_accountsteam_id_c" class="sugar_field" data-id-value="{$fields.scrm_accountsteam_id_c.value}">{$fields.accountsteam_c.value}</span>
{if !empty($fields.scrm_accountsteam_id_c.value)}</a>{/if}
{/if}
</div>
</div>
</div>
