...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.doc_uploaded_c.name}" 
id="{$fields.doc_uploaded_c.name}" 
title=''       
>
{if isset($fields.doc_uploaded_c.value) && $fields.doc_uploaded_c.value != ''}
{html_options options=$fields.doc_uploaded_c.options selected=$fields.doc_uploaded_c.value}
{else}
{html_options options=$fields.doc_uploaded_c.options selected=$fields.doc_uploaded_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.doc_uploaded_c.options }
{capture name="field_val"}{$fields.doc_uploaded_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.doc_uploaded_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.doc_uploaded_c.name}" 
id="{$fields.doc_uploaded_c.name}" 
title=''          
>
{if isset($fields.doc_uploaded_c.value) && $fields.doc_uploaded_c.value != ''}
...
<input
id="{$fields.doc_uploaded_c.name}-input"
name="{$fields.doc_uploaded_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.doc_uploaded_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.doc_uploaded_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.doc_uploaded_c.name}-input', '{$fields.doc_uploaded_c.name}');sync_{$fields.doc_uploaded_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.doc_uploaded_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.doc_uploaded_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.doc_uploaded_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.doc_uploaded_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.doc_uploaded_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.doc_uploaded_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.doc_uploaded_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.doc_uploaded_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.doc_uploaded_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_REASONFORRESCHEDULE' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.reasonforreschedule_c.value)}
{assign var="value" value=$fields.reasonforreschedule_c.default_value }
{else}
{assign var="value" value=$fields.reasonforreschedule_c.value }
{/if}
<textarea  id='{$fields.reasonforreschedule_c.name}' name='{$fields.reasonforreschedule_c.name}'
rows="4"
cols="30"
title='' tabindex="0" 
 >{$value}</textarea>
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.servicetype_c.name}" 
id="{$fields.servicetype_c.name}" 
title=''       
>
{if isset($fields.servicetype_c.value) && $fields.servicetype_c.value != ''}
{html_options options=$fields.servicetype_c.options selected=$fields.servicetype_c.value}
{else}
{html_options options=$fields.servicetype_c.options selected=$fields.servicetype_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.servicetype_c.options }
{capture name="field_val"}{$fields.servicetype_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.servicetype_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.servicetype_c.name}" 
id="{$fields.servicetype_c.name}" 
title=''          
>
{if isset($fields.servicetype_c.value) && $fields.servicetype_c.value != ''}
...
<input
id="{$fields.servicetype_c.name}-input"
name="{$fields.servicetype_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.servicetype_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.servicetype_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.servicetype_c.name}-input', '{$fields.servicetype_c.name}');sync_{$fields.servicetype_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.servicetype_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.servicetype_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.servicetype_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.servicetype_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.servicetype_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.servicetype_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.servicetype_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.servicetype_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.servicetype_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
600, 
400, 
"&branch_c_advanced[]={$fields.region_c.value}", 
true, 
false, 
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ACCOUNTSTEAM' module='Cases'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<input type="text" name="{$fields.accountsteam_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.accountsteam_c.name}" size="" value="{$fields.accountsteam_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.accountsteam_c.id_name}" 
id="{$fields.accountsteam_c.id_name}" 
value="{$fields.scrm_accountsteam_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.accountsteam_c.name}" id="btn_{$fields.accountsteam_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.accountsteam_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"scrm_accountsteam_id_c","name":"accountsteam_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.accountsteam_c.name}" id="btn_clr_{$fields.accountsteam_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.accountsteam_c.name}', '{$fields.accountsteam_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.accountsteam_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
addToValidate('EditView', 'casetype_c', 'enum', true,'{/literal}{sugar_translate label='LBL_CASETYPE' module='Cases' for_js=true}{literal}' );
...
addToValidate('EditView', 'servicetype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SERVICETYPE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'meetings_cases_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MEETINGS_CASES_1_FROM_MEETINGS_TITLE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'doc_uploaded_c', 'enum', false,'{/literal}{sugar_translate label='LBL_DOC_UPLOADED' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'reasonforreschedule_c', 'text', false,'{/literal}{sugar_translate label='LBL_REASONFORRESCHEDULE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'scrm_accounts_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_ACCOUNTS_SCRM_ACCOUNTS_ID' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'accounts_c', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNTS' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'scrm_accountsteam_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_ACCOUNTSTEAM_SCRM_ACCOUNTSTEAM_ID' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'accountsteam_c', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNTSTEAM' module='Cases' for_js=true}{literal}' );
