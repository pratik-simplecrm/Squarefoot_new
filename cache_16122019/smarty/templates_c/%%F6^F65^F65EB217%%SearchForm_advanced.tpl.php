<?php /* Smarty version 2.6.29, created on 2019-12-16 13:48:29
         compiled from cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl', 46, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl', 127, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Cases/SearchForm_advanced.tpl', 158, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='region_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_REGION','module' => 'Cases'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
<?php echo smarty_function_html_options(array('id' => 'region_c_advanced','name' => 'region_c_advanced[]','options' => $this->_tpl_vars['fields']['region_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['region_c_advanced']['value']), $this);?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_account_name_advanced\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_account_name_advanced","account_id_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_contact_created_by_name_advanced\']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_created_by_name_advanced","contact_created_by_id_advanced","contact_created_by_id_advanced","contact_created_by_id_advanced"],"required_list":["contact_created_by_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_contractor_c_advanced\']={"form":"search_form","method":"query","modules":["scrm_Vendors"],"group":"or","field_list":["name","id"],"populate_list":["contractor_c_advanced","scrm_vendors_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_supervisor_c_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["supervisor_c_advanced","user_id_c_advanced"],"required_list":["user_id_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_opportunities_cases_1_name_advanced\']={"form":"search_form","method":"query","modules":["Opportunities"],"group":"or","field_list":["name","id"],"populate_list":["opportunities_cases_1_name_advanced","opportunities_cases_1opportunities_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_warehouse_person_c_advanced\']={"form":"search_form","method":"query","modules":["scrm_Warehouse_Person"],"group":"or","field_list":["name","id"],"populate_list":["warehouse_person_c_advanced","scrm_warehouse_person_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_salesperson_c_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["salesperson_c_advanced","user_id1_c_advanced"],"required_list":["user_id1_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_salescoordinator_c_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["salescoordinator_c_advanced","user_id2_c_advanced"],"required_list":["user_id2_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_meetings_cases_1_name_advanced\']={"form":"search_form","method":"query","modules":["Meetings"],"group":"or","field_list":["name","id"],"populate_list":["meetings_cases_1_name_advanced","meetings_cases_1meetings_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_accounts_c_advanced\']={"form":"search_form","method":"query","modules":["scrm_Accounts"],"group":"or","field_list":["name","id"],"populate_list":["accounts_c_advanced","scrm_accounts_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_accountsteam_c_advanced\']={"form":"search_form","method":"query","modules":["scrm_accountsteam"],"group":"or","field_list":["name","id"],"populate_list":["accountsteam_c_advanced","scrm_accountsteam_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>