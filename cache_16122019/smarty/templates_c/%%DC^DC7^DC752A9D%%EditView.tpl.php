...
<?php ob_start(); ?>
<tr>
<td valign="top" id='casetype_c_label' width='12.5%' data-total-columns="1" scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='doc_uploaded_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['doc_uploaded_c']['value'] ) && $this->_tpl_vars['fields']['doc_uploaded_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['doc_uploaded_c']['options'],'selected' => $this->_tpl_vars['fields']['doc_uploaded_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['doc_uploaded_c']['options'],'selected' => $this->_tpl_vars['fields']['doc_uploaded_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['doc_uploaded_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['doc_uploaded_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['doc_uploaded_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>
<td valign="top" id='reasonforreschedule_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php if (empty ( $this->_tpl_vars['fields']['reasonforreschedule_c']['value'] )):  $this->assign('value', $this->_tpl_vars['fields']['reasonforreschedule_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['reasonforreschedule_c']['value']);  endif; ?>
<textarea  id='<?php echo $this->_tpl_vars['fields']['reasonforreschedule_c']['name']; ?>
' name='<?php echo $this->_tpl_vars['fields']['reasonforreschedule_c']['name']; ?>
'
rows="4"
cols="30"
title='' tabindex="0" 
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='servicetype_c_label' width='12.5%' data-total-columns="1" scope="col">
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['servicetype_c']['value'] ) && $this->_tpl_vars['fields']['servicetype_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['servicetype_c']['options'],'selected' => $this->_tpl_vars['fields']['servicetype_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['servicetype_c']['options'],'selected' => $this->_tpl_vars['fields']['servicetype_c']['default']), $this);?>
...
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['servicetype_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['servicetype_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['servicetype_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['servicetype_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['servicetype_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['servicetype_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
600, 
400, 
"&branch_c_advanced[]=<?php echo $this->_tpl_vars['fields']['region_c']['value']; ?>
", 
true, 
false, 
...
<td valign="top" id='accountsteam_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['accountsteam_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['accountsteam_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['accountsteam_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['scrm_accountsteam_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['accountsteam_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"scrm_accountsteam_id_c","name":"accountsteam_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['accountsteam_c']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['accountsteam_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='priority_label' width='12.5%' data-total-columns="1" scope="col">
...
addToValidate(\'EditView\', \'casetype_c\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CASETYPE','module' => 'Cases','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'servicetype_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SERVICETYPE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'meetings_cases_1_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEETINGS_CASES_1_FROM_MEETINGS_TITLE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'doc_uploaded_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOC_UPLOADED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'reasonforreschedule_c\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REASONFORRESCHEDULE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'scrm_accounts_id_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTS_SCRM_ACCOUNTS_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'accounts_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTS','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'scrm_accountsteam_id_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTSTEAM_SCRM_ACCOUNTSTEAM_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'accountsteam_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTSTEAM','module' => 'Cases','for_js' => true), $this); echo '\' );
