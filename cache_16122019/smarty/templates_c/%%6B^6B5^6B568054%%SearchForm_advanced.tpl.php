<?php /* Smarty version 2.6.29, created on 2019-12-16 14:03:00
         compiled from cache/themes/SuiteR/modules/scrm_Accounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/scrm_Accounts/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/scrm_Accounts/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/scrm_Accounts/SearchForm_advanced.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/scrm_Accounts/SearchForm_advanced.tpl', 46, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/scrm_Accounts/SearchForm_advanced.tpl', 153, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='first_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'scrm_Accounts'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='last_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'scrm_Accounts'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='created_by_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'scrm_Accounts'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='do_not_call_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DO_NOT_CALL','module' => 'scrm_Accounts'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'scrm_Accounts'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
