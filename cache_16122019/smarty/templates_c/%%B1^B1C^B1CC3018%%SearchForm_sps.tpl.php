...
" value='<?php if (empty ( $_REQUEST['range_date_modified_basic'] ) && ! empty ( $_REQUEST['date_modified_basic'] )):  echo $_REQUEST['date_modified_basic'];  else:  echo $_REQUEST['range_date_modified_basic'];  endif; ?>' title=''   size="11" class="dateRangeInput">
