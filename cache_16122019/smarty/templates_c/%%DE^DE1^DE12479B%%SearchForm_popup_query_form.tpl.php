<?php /* Smarty version 2.6.29, created on 2019-12-16 13:57:49
         compiled from cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl', 46, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl', 164, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/scrm_Vendors/SearchForm_popup_query_form.tpl', 278, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='first_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='last_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='address_city_advanced'><?php echo smarty_function_sugar_translate(array('label' => '','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='created_by_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='do_not_call_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DO_NOT_CALL','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='branch_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BRANCH','module' => 'scrm_Vendors'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
                        
<?php echo smarty_function_html_options(array('id' => 'branch_c_advanced','name' => 'branch_c_advanced[]','options' => $this->_tpl_vars['fields']['branch_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['branch_c_advanced']['value']), $this);?>
