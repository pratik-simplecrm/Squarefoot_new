<?php /* Smarty version 2.6.29, created on 2019-12-10 11:20:37
         compiled from cache/modules/AOW_WorkFlow/CasesEditViewmultienumstate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'multienum_to_array', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstate.tpl', 7, false),array('function', 'html_options', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstate.tpl', 12, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstate.tpl', 41, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstate.tpl', 79, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>

	<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['state']['name']; ?>
_multiselect"
	name="<?php echo $this->_tpl_vars['fields']['state']['name']; ?>
_multiselect" value="true">
	<?php echo smarty_function_multienum_to_array(array('string' => $this->_tpl_vars['fields']['state']['value'],'default' => $this->_tpl_vars['fields']['state']['default'],'assign' => 'values'), $this);?>

	<select id="<?php echo $this->_tpl_vars['fields']['state']['name']; ?>
"
	name="<?php echo $this->_tpl_vars['fields']['state']['name']; ?>
[]"
	multiple="true" size='6' style="width:150" title='' tabindex="1"  
     	>
	<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['state']['options'],'selected' => $this->_tpl_vars['values']), $this);?>
...
_multiselect" value="true">
		...
		<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['state']['name']; ?>
"
		name="<?php echo $this->_tpl_vars['fields']['state']['name']; ?>
[]"
		multiple="true" size='6' style="width:150" title='' tabindex="1"  
...
.minQLen<?php echo ' == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("';  echo $this->_tpl_vars['fields']['state']['name']; ?>
-input<?php echo '"))
