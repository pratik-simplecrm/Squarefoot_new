...
<input class="date_input" autocomplete="off" type="text" name="{$fields.startdate_c.name}" id="{$fields.startdate_c.name}" value="{$date_value}" title=''  tabindex='1'    size="11" maxlength="10" >
