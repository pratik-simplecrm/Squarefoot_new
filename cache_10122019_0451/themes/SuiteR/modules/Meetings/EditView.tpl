...
{capture name="label" assign="label"}{sugar_translate label='LBL_MEETINGTYPE' module='Meetings'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ACCOUNTNAME' module='Meetings'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<input type="text" name="{$fields.accountname_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.accountname_c.name}" size="" value="{$fields.accountname_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.accountname_c.id_name}" 
id="{$fields.accountname_c.id_name}" 
value="{$fields.account_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.accountname_c.name}" id="btn_{$fields.accountname_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
"{$fields.accountname_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id_c","name":"accountname_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.accountname_c.name}" id="btn_clr_{$fields.accountname_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.accountname_c.name}', '{$fields.accountname_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.accountname_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SUPERVISOR' module='Meetings'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"user_id1_c","name":"supervisor_c"}}{/literal}, 
"single", 
true
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OPPORTUNITIES' module='Meetings'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<input type="text" name="{$fields.opportunities_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.opportunities_c.name}" size="" value="{$fields.opportunities_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.opportunities_c.id_name}" 
id="{$fields.opportunities_c.id_name}" 
value="{$fields.opportunity_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.opportunities_c.name}" id="btn_{$fields.opportunities_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.opportunities_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"opportunity_id_c","name":"opportunities_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.opportunities_c.name}" id="btn_clr_{$fields.opportunities_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.opportunities_c.name}', '{$fields.opportunities_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.opportunities_c.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
<td valign="top" id='flag_c_label' width='12.5%' data-total-columns="2" scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_FLAG' module='Meetings'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.flag_c.name}" 
id="{$fields.flag_c.name}" 
title=''       
>
{if isset($fields.flag_c.value) && $fields.flag_c.value != ''}
{html_options options=$fields.flag_c.options selected=$fields.flag_c.value}
{else}
{html_options options=$fields.flag_c.options selected=$fields.flag_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.flag_c.options }
{capture name="field_val"}{$fields.flag_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.flag_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.flag_c.name}" 
id="{$fields.flag_c.name}" 
title=''          
>
{if isset($fields.flag_c.value) && $fields.flag_c.value != ''}
...
<input
id="{$fields.flag_c.name}-input"
name="{$fields.flag_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.flag_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.flag_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.flag_c.name}-input', '{$fields.flag_c.name}');sync_{$fields.flag_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.flag_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.flag_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.flag_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.flag_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.flag_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.flag_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.flag_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.flag_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.flag_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'opportunity_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_OPPORTUNITY_ID' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'opportunities_c', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'meetingtype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MEETINGTYPE' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_SALES_PERSON_USER_ID' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'sales_person_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SALES_PERSON' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'account_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_ACCOUNTNAME_ACCOUNT_ID' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'accountname_c', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNTNAME' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'user_id1_c', 'id', false,'{/literal}{sugar_translate label='LBL_SUPERVISOR_USER_ID' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'supervisor_c', 'relate', true,'{/literal}{sugar_translate label='LBL_SUPERVISOR' module='Meetings' for_js=true}{literal}' );
addToValidate('EditView', 'flag_c', 'enum', false,'{/literal}{sugar_translate label='LBL_FLAG' module='Meetings' for_js=true}{literal}' );
