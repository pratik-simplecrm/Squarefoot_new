...
addToValidate('form_QuickCreate_Accounts', 'opportunity_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITY_OPPORTUNITY_ID' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'opportunity_c', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITY' module='Accounts' for_js=true}{literal}' );
