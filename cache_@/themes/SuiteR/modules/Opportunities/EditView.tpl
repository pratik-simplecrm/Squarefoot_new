...
<li class="selected"><a id="tab2" href="javascript:void(2)"><em>{sugar_translate label='LBL_EDITVIEW_PANEL1' module='Opportunities'}</em></a></li>
</ul>
...
{assign var="value" value=09-12-2019 }
...
<span class="dateTime">
{assign var=date_value value=$fields.closure_date_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.closure_date_c.name}" id="{$fields.closure_date_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.closure_date_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.closure_date_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.closure_date_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.meetingtype_c.name}" 
id="{$fields.meetingtype_c.name}" 
title=''       
>
{if isset($fields.meetingtype_c.value) && $fields.meetingtype_c.value != ''}
{html_options options=$fields.meetingtype_c.options selected=$fields.meetingtype_c.value}
{else}
{html_options options=$fields.meetingtype_c.options selected=$fields.meetingtype_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.meetingtype_c.options }
{capture name="field_val"}{$fields.meetingtype_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.meetingtype_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.meetingtype_c.name}" 
id="{$fields.meetingtype_c.name}" 
title=''          
>
{if isset($fields.meetingtype_c.value) && $fields.meetingtype_c.value != ''}
...
<input
id="{$fields.meetingtype_c.name}-input"
name="{$fields.meetingtype_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.meetingtype_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.meetingtype_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.meetingtype_c.name}-input', '{$fields.meetingtype_c.name}');sync_{$fields.meetingtype_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.meetingtype_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.meetingtype_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.meetingtype_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.meetingtype_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.meetingtype_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.meetingtype_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.meetingtype_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.meetingtype_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.meetingtype_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.reasonforrschedule_c.name}" 
id="{$fields.reasonforrschedule_c.name}" 
title=''       
>
{if isset($fields.reasonforrschedule_c.value) && $fields.reasonforrschedule_c.value != ''}
{html_options options=$fields.reasonforrschedule_c.options selected=$fields.reasonforrschedule_c.value}
{else}
{html_options options=$fields.reasonforrschedule_c.options selected=$fields.reasonforrschedule_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.reasonforrschedule_c.options }
{capture name="field_val"}{$fields.reasonforrschedule_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.reasonforrschedule_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.reasonforrschedule_c.name}" 
id="{$fields.reasonforrschedule_c.name}" 
title=''          
>
{if isset($fields.reasonforrschedule_c.value) && $fields.reasonforrschedule_c.value != ''}
...
<input
id="{$fields.reasonforrschedule_c.name}-input"
name="{$fields.reasonforrschedule_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.reasonforrschedule_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.reasonforrschedule_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.reasonforrschedule_c.name}-input', '{$fields.reasonforrschedule_c.name}');sync_{$fields.reasonforrschedule_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.reasonforrschedule_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.reasonforrschedule_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.reasonforrschedule_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.reasonforrschedule_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.reasonforrschedule_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.reasonforrschedule_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.reasonforrschedule_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.reasonforrschedule_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.reasonforrschedule_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.triggerfield_c.name}" 
id="{$fields.triggerfield_c.name}" 
title=''       
>
{if isset($fields.triggerfield_c.value) && $fields.triggerfield_c.value != ''}
{html_options options=$fields.triggerfield_c.options selected=$fields.triggerfield_c.value}
{else}
{html_options options=$fields.triggerfield_c.options selected=$fields.triggerfield_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.triggerfield_c.options }
{capture name="field_val"}{$fields.triggerfield_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.triggerfield_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.triggerfield_c.name}" 
id="{$fields.triggerfield_c.name}" 
title=''          
>
{if isset($fields.triggerfield_c.value) && $fields.triggerfield_c.value != ''}
...
<input
id="{$fields.triggerfield_c.name}-input"
name="{$fields.triggerfield_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.triggerfield_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.triggerfield_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.triggerfield_c.name}-input', '{$fields.triggerfield_c.name}');sync_{$fields.triggerfield_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.triggerfield_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.triggerfield_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.triggerfield_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.triggerfield_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.triggerfield_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.triggerfield_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.triggerfield_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.triggerfield_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.triggerfield_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
<input type="text" name="{$fields.servicecoordinator_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.servicecoordinator_c.name}" size="" value="{$fields.servicecoordinator_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.servicecoordinator_c.id_name}" 
id="{$fields.servicecoordinator_c.id_name}" 
value="{$fields.user_id1_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.servicecoordinator_c.name}" id="btn_{$fields.servicecoordinator_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_LABEL"}"
onclick='open_popup(
"{$fields.servicecoordinator_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"user_id1_c","name":"servicecoordinator_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.servicecoordinator_c.name}" id="btn_clr_{$fields.servicecoordinator_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.servicecoordinator_c.name}', '{$fields.servicecoordinator_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.servicecoordinator_c.name}']) != 'undefined'",
		enableQS
);
</script>
...
maxlength='255' 
value='{$value}' title='Geocode Status'      >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
addToValidate('EditView', 'cstm_activity_count_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_UPLOAD_QUOTE_CSTM_ACTIVITY_COUNT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'note_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_UPLOAD_PO_COPY_NOTE_ID' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'upload_documents_c', 'enum', false,'{/literal}{sugar_translate label='LBL_UPLOAD_DOCUMENTS' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'file_url', 'varchar', false,'{/literal}{sugar_translate label='LBL_FILE_URL' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'upload_po_copy_c', 'relate', false,'{/literal}{sugar_translate label='LBL_UPLOAD_PO_COPY' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'upload_quote_c', 'relate', false,'{/literal}{sugar_translate label='LBL_UPLOAD_QUOTE' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_SUPERVISOR_USER_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'supervisor_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SUPERVISOR' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'meetingtype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MEETINGTYPE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'reasonforrschedule_c', 'enum', false,'{/literal}{sugar_translate label='LBL_REASONFORRSCHEDULE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'triggerfield_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TRIGGERFIELD' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'user_id1_c', 'id', false,'{/literal}{sugar_translate label='LBL_SERVICECOORDINATOR_USER_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'servicecoordinator_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SERVICECOORDINATOR' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'user_id2_c', 'id', false,'{/literal}{sugar_translate label='LBL_SALESCOORDINATOR_USER_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'salescoordinator_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SALESCOORDINATOR' module='Opportunities' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'created_by_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CREATED' module='Opportunities' for_js=true}{literal}', 'created_by' );
...
addToValidateBinaryDependency('EditView', 'supervisor_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SUPERVISOR' module='Opportunities' for_js=true}{literal}', 'user_id_c' );
addToValidateBinaryDependency('EditView', 'servicecoordinator_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SERVICECOORDINATOR' module='Opportunities' for_js=true}{literal}', 'user_id1_c' );
addToValidateBinaryDependency('EditView', 'salescoordinator_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SALESCOORDINATOR' module='Opportunities' for_js=true}{literal}', 'user_id2_c' );
