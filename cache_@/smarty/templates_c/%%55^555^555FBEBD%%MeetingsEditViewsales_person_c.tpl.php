<?php /* Smarty version 2.6.29, created on 2019-12-09 09:58:20
         compiled from cache/modules/AOW_WorkFlow/MeetingsEditViewsales_person_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/modules/AOW_WorkFlow/MeetingsEditViewsales_person_c.tpl', 7, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/MeetingsEditViewsales_person_c.tpl', 18, false),)), $this); ?>

<input type="text" name="<?php echo $this->_tpl_vars['fields']['sales_person_c']['name']; ?>
" class="sqsEnabled" tabindex="1" id="<?php echo $this->_tpl_vars['fields']['sales_person_c']['name']; ?>
...
"<?php echo ',"name":'; ?>
"<?php echo $this->_tpl_vars['fields']['sales_person_c']['name']; ?>
"<?php echo '}}'; ?>
, 
	"single", 
	true
