<?php /* Smarty version 2.6.29, created on 2019-12-09 11:01:33
         compiled from cache/modules/AOW_WorkFlow/MeetingsEditViewparent_type.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/AOW_WorkFlow/MeetingsEditViewparent_type.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/MeetingsEditViewparent_type.tpl', 43, false),array('modifier', 'lookup', 'cache/modules/AOW_WorkFlow/MeetingsEditViewparent_type.tpl', 38, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/MeetingsEditViewparent_type.tpl', 143, false),)), $this); ?>
...
<?php else: ?>
	...
	<?php ob_start();  echo $this->_tpl_vars['fields']['parent_type']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['parent_type']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
...
"></button>
	...
	'; ?>
			...
			<?php echo '
		(function (){
			var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['parent_type']['name'];  echo '");
...
');
			...
			//global variable 
			sync_';  echo $this->_tpl_vars['fields']['parent_type']['name'];  echo ' = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['parent_type']['name']; ?>
-input<?php echo '\'))
						SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['parent_type']['name'];  echo '", syncFromHiddenToWidget);
		'; ?>
