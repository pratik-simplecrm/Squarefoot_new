...
<li class="selected"><a id="tab2" href="javascript:void(2)"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL1','module' => 'Opportunities'), $this);?>
</em></a></li>
</ul>
...
' title='' tabindex='0'
>
<td valign="top" id='opportunity_type_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='date_entered_label' width='12.5%' data-total-columns="1" scope="col">
...
<?php $this->assign('value', "09-12-2019"); ?>
...
' title='' tabindex='0'    >
<td valign="top" id='closure_date_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['closure_date_c']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['closure_date_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['closure_date_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex='0'    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['closure_date_c']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>

</span>
<script type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['closure_date_c']['name']; ?>
",
form : "EditView",
ifFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
daFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
button : "<?php echo $this->_tpl_vars['fields']['closure_date_c']['name']; ?>
_trigger",
singleClick : true,
dateStr : "<?php echo $this->_tpl_vars['date_value']; ?>
",
...
<?php endif; ?>
<td valign="top" id='jjwg_maps_lat_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MEETINGTYPE','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php endif; ?>
<td valign="top" id='reasonforrschedule_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_REASONFORRSCHEDULE','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['reasonforrschedule_c']['value'] ) && $this->_tpl_vars['fields']['reasonforrschedule_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['reasonforrschedule_c']['options'],'selected' => $this->_tpl_vars['fields']['reasonforrschedule_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['reasonforrschedule_c']['options'],'selected' => $this->_tpl_vars['fields']['reasonforrschedule_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['reasonforrschedule_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SUPERVISOR','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td valign="top" id='triggerfield_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TRIGGERFIELD','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['triggerfield_c']['value'] ) && $this->_tpl_vars['fields']['triggerfield_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['triggerfield_c']['options'],'selected' => $this->_tpl_vars['fields']['triggerfield_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['triggerfield_c']['options'],'selected' => $this->_tpl_vars['fields']['triggerfield_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['triggerfield_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['triggerfield_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['triggerfield_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['triggerfield_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['triggerfield_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['triggerfield_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['triggerfield_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['triggerfield_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='servicecoordinator_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SERVICECOORDINATOR','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['user_id1_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_USERS_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_USERS_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"user_id1_c","name":"servicecoordinator_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_USERS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_USERS_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['servicecoordinator_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
<td valign="top" id='salescoordinator_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SALESCOORDINATOR','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='jjwg_maps_geocode_status_c_label' width='12.5%' data-total-columns="1" scope="col">
...
addToValidate(\'EditView\', \'cstm_activity_count_id_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UPLOAD_QUOTE_CSTM_ACTIVITY_COUNT_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'note_id_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UPLOAD_PO_COPY_NOTE_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'upload_documents_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UPLOAD_DOCUMENTS','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'filename\', \'file\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FILENAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'file_mime_type\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FILE_MIME_TYPE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'file_url\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FILE_URL','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'upload_po_copy_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UPLOAD_PO_COPY','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'upload_quote_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UPLOAD_QUOTE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'user_id_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUPERVISOR_USER_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'supervisor_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUPERVISOR','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'meetingtype_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEETINGTYPE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'reasonforrschedule_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REASONFORRSCHEDULE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'triggerfield_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TRIGGERFIELD','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'user_id1_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SERVICECOORDINATOR_USER_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'servicecoordinator_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SERVICECOORDINATOR','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'user_id2_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SALESCOORDINATOR_USER_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'salescoordinator_c\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SALESCOORDINATOR','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'created_by_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Opportunities','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Opportunities','for_js' => true), $this); echo '\', \'created_by\' );
...
addToValidateBinaryDependency(\'EditView\', \'supervisor_c\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Opportunities','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUPERVISOR','module' => 'Opportunities','for_js' => true), $this); echo '\', \'user_id_c\' );
addToValidateBinaryDependency(\'EditView\', \'servicecoordinator_c\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Opportunities','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_SERVICECOORDINATOR','module' => 'Opportunities','for_js' => true), $this); echo '\', \'user_id1_c\' );
addToValidateBinaryDependency(\'EditView\', \'salescoordinator_c\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Opportunities','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_SALESCOORDINATOR','module' => 'Opportunities','for_js' => true), $this); echo '\', \'user_id2_c\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_account_name\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["EditView_account_name","account_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_created_by_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name","created_by"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_arch_architectural_firm_opportunities_1_name\']={"form":"EditView","method":"query","modules":["Arch_Architectural_Firm"],"group":"or","field_list":["name","id"],"populate_list":["arch_architectural_firm_opportunities_1_name","arch_archi003bal_firm_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_arch_architects_contacts_opportunities_1_name\']={"form":"EditView","method":"query","modules":["Arch_Architects_Contacts"],"group":"or","field_list":["name","id"],"populate_list":["arch_architects_contacts_opportunities_1_name","arch_archi342contacts_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_campaign_name\']={"form":"EditView","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_id","campaign_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_supervisor_c\']={"form":"EditView","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["supervisor_c","user_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_servicecoordinator_c\']={"form":"EditView","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["servicecoordinator_c","user_id1_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_salescoordinator_c\']={"form":"EditView","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["salescoordinator_c","user_id2_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
