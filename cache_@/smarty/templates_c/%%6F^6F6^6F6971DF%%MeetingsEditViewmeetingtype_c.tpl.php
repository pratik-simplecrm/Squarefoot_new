...
" 
	...
	<?php if (isset ( $this->_tpl_vars['fields']['meetingtype_c']['value'] ) && $this->_tpl_vars['fields']['meetingtype_c']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['meetingtype_c']['options'],'selected' => $this->_tpl_vars['fields']['meetingtype_c']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['meetingtype_c']['options'],'selected' => $this->_tpl_vars['fields']['meetingtype_c']['default']), $this);?>
