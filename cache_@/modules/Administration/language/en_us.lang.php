...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_LISTVIEW_FIELD_BACKGROUND_LINK_NAME' => 'Apply ListView field background color.',
  'LBL_LISTVIEW_FIELD_BACKGROUND_LINK_DESCRIPTION' => 'Apply background color for field like status.',
  'LBL_LISTVIEW_FIELD_BACKGROUND_SECTION_HEADER' => 'Field Background for ListView',
  'LBL_LISTVIEW_FIELD_BACKGROUND_SECTION_DESCRIPTION' => 'Set up different color background for listview and dashlets',
  'LBL_FACEBOOK_CAMPAIGN_CONNECTOR_TITLE' => 'Click to Configure Facebook Campaign',
  'LBL_FACEBOOK_CAMPAIGN_CONNECTOR_DESCRIPTION' => 'Here you can configure settings for Facebook Campaign.',
  'LBL_FACEBOOK_CAMPAIGN_CONNECTOR_LINKS_TITLE' => 'Facebook Campaign Configuration',
  'LBL_FACEBOOK_CAMPAIGN_CONNECTOR_LINKS_DESCRIPTION' => 'Configure Facebook Campaign Settings',
  'LBL_SAMPLELICENSEADDON' => 'SimpleCRM Facebook Connector License Add-on',
  'LBL_SAMPLELICENSEADDON_LICENSE_TITLE' => 'License Configuration',
  'LBL_SAMPLELICENSEADDON_LICENSE' => 'Manage and configure the license for this add-on',
  'LBL_LEAD_SCORING_LINK_NAME' => 'Configure Lead & Opportunities Scoring',
  'LBL_LEAD_SCORING_LINK_DESCRIPTION' => 'Lead & Opportunities Scoring Configure',
  'LBL_LEAD_SCORING_SECTION_HEADER' => 'Lead & Opportunities Scoring',
  'LBL_LEAD_SCORING_SECTION_DESCRIPTION' => 'Set up values for configuring lead & opportunities scoring',
  'LBL_LINK_NAME' => 'Dashboard Manager',
  'LBL_LINK_DESCRIPTION' => 'Copy dashboard of any user to other single or multiple users.',
  'LBL_SECTION_HEADER' => 'Dashboard Manager',
  'LBL_SECTION_DESCRIPTION' => 'Dashboard Manager ',
  ...
  'LBL_ICON_PICKER_LINK_NAME' => 'Custom Icons For Modules',
  'LBL_ICON_PICKER_LINK_DESCRIPTION' => 'Custom Icons For Modules',
  'LBL_ICON_PICKER_SECTION_HEADER' => 'Custom Icons For Modules',
  'LBL_ICON_PICKER_SECTION_DESCRIPTION' => 'Custom Icons For Modules',
  'LBL_TEAMS_ADMIN' => 'Team Management',
  'LBL_TEAMS_ADMIN_DESCRIPTION' => 'Manage team membership and properties',
  'LBL_FACEBOOK_CONNECTOR_TITLE' => 'Click to Configure Facebook',
  'LBL_FACEBOOK_CONNECTOR_DESCRIPTION' => 'Here you can configure settings for Facebook.',
  'LBL_FACEBOOK_CONNECTOR_LINKS_TITLE' => 'Facebook Configuration',
  'LBL_FACEBOOK_CONNECTOR_LINKS_DESCRIPTION' => 'Configure Facebook Settings',
);