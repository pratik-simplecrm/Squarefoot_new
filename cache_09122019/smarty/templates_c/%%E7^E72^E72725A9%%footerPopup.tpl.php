...
<script>
    ...
    var listViewSearchIcon = {
        ...
        searchInfo: ';  echo $this->_tpl_vars['searchInfoJson'];  echo ',
...
'<?php echo ',
        ...
        // private
        latestSearchDialogType: \'';  echo $this->_tpl_vars['viewTab'];  echo '\',
        ...
        toggleSearchDialog: function (dialogType) {
            ...
            SUGAR.searchForm.searchFormSelect(\'';  echo $this->_tpl_vars['module'];  echo '|\' + dialogType + \'_search\', \'';  echo $this->_tpl_vars['module'];  echo '|\' + (dialogType == \'advanced\' ? \'basic\' : \'advanced\') + \'_search\');
        },
