<?php 
 $GLOBALS["dictionary"]["scrm_Vendor"]=array (
  'table' => 'scrm_vendor',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendor_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendor_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendor_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_scrm_vendor',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendor_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendor_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'len' => '100',
      'size' => '20',
      'id' => 'scrm_Vendorfirst_name_c',
      'custom_module' => 'scrm_Vendor',
    ),
    'last_name_c' => 
    array (
      'required' => false,
