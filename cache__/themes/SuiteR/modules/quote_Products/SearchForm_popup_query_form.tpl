...
{html_options id='tax_class_c_advanced' name='tax_class_c_advanced[]' options=$fields.tax_class_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.tax_class_c_advanced.value}
                    </td>
...
{html_options id='uom_c_advanced' name='uom_c_advanced[]' options=$fields.uom_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.uom_c_advanced.value}
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='is_dutyfree_c_advanced'>{sugar_translate label='LBL_IS_DUTYFREE' module='quote_Products'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
{if strval($fields.is_dutyfree_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.is_dutyfree_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.is_dutyfree_c_advanced.name}" name="{$fields.is_dutyfree_c_advanced.name}"   >
