...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Meetings","field_to_name_array":{"id":"opportunity_id_c","name":"opportunities_c"}}{/literal}, 
"single", 
true
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SALES_PERSON' module='Meetings'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<input type="text" name="{$fields.sales_person_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.sales_person_c.name}" size="" value="{$fields.sales_person_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.sales_person_c.id_name}" 
id="{$fields.sales_person_c.id_name}" 
value="{$fields.user_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.sales_person_c.name}" id="btn_{$fields.sales_person_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Meetings","field_to_name_array":{"id":"user_id_c","name":"sales_person_c"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.sales_person_c.name}" id="btn_clr_{$fields.sales_person_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_TITLE"}"  class="button lastChild"
...
addToValidate('form_SubpanelQuickCreate_Meetings', 'opportunity_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_OPPORTUNITY_ID' module='Meetings' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Meetings', 'opportunities_c', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES' module='Meetings' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Meetings', 'meetingtype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MEETINGTYPE' module='Meetings' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Meetings', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_SALES_PERSON_USER_ID' module='Meetings' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Meetings', 'sales_person_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SALES_PERSON' module='Meetings' for_js=true}{literal}' );
