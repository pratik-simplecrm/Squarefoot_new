...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='scrm_ScheduleHistory'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CASE_NUMBER' module='scrm_ScheduleHistory'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
id='{$fields.case_number_c.name}' size='30' maxlength='50' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_REASONOFRESCHEDULE' module='scrm_ScheduleHistory'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_STARTDATE' module='scrm_ScheduleHistory'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CASETYPE' module='scrm_ScheduleHistory'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='scrm_ScheduleHistory'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SUPERVISOR' module='scrm_ScheduleHistory'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'reasonofreschedule_c', 'enum', false,'{/literal}{sugar_translate label='LBL_REASONOFRESCHEDULE' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'startdate_c_date', 'date', false,'Start Date & Time' );
addToValidate('EditView', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CREATEDBY_USER_ID' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'createdby_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATEDBY' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'cases_scrm_schedulehistory_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CASES_SCRM_SCHEDULEHISTORY_1_FROM_CASES_TITLE' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'casetype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CASETYPE' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'user_id1_c', 'id', false,'{/literal}{sugar_translate label='LBL_SUPERVISOR_USER_ID' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'supervisor_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SUPERVISOR' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidate('EditView', 'case_number_c', 'int', false,'{/literal}{sugar_translate label='LBL_CASE_NUMBER' module='scrm_ScheduleHistory' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='scrm_ScheduleHistory' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='scrm_ScheduleHistory' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'supervisor_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='scrm_ScheduleHistory' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SUPERVISOR' module='scrm_ScheduleHistory' for_js=true}{literal}', 'user_id1_c' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_supervisor_c']={"form":"EditView","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["supervisor_c","user_id1_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}
