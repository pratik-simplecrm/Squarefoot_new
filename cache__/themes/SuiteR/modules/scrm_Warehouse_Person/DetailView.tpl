...
{/php}
<ul id="detail_header_action_menu" class="clickMenu fancymenu" ><li class="sugar_action_button" >{if $bean->aclAccess("edit")}<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='scrm_Warehouse_Person'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='EditView';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Edit" id="edit_button" value="{$APP.LBL_EDIT_BUTTON_LABEL}">{/if} <ul id class="subnav" ><li>{if $bean->aclAccess("edit")}<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='scrm_Warehouse_Person'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='{$id}';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}" id="duplicate_button">{/if} </li><li>{if $bean->aclAccess("delete")}<input title="{$APP.LBL_DELETE_BUTTON_TITLE}" accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='scrm_Warehouse_Person'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('{$APP.NTC_DELETE_CONFIRMATION}')) SUGAR.ajaxUI.submitForm(_form); return false;" type="submit" name="Delete" value="{$APP.LBL_DELETE_BUTTON_LABEL}" id="delete_button">{/if} </li><li>{if $bean->aclAccess("edit") && $bean->aclAccess("delete")}<input title="{$APP.LBL_DUP_MERGE}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='scrm_Warehouse_Person'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='Step1'; _form.module.value='MergeRecords';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Merge" value="{$APP.LBL_DUP_MERGE}" id="merge_duplicate_button">{/if} </li><li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=scrm_Warehouse_Person", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li></ul></li></ul>
{$ADMIN_EDIT}
{$PAGINATION}
</div>
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='scrm_Warehouse_Person'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OFFICE_PHONE' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TITLE' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MOBILE_PHONE' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DEPARTMENT' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_HOME_PHONE' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.regionname_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_REGIONNAME' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{if is_string($fields.regionname_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.regionname_c.name}" value="{ $fields.regionname_c.options }">
{ $fields.regionname_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.regionname_c.name}" value="{ $fields.regionname_c.value }">
{ $fields.regionname_c.options[$fields.regionname_c.value]}
{/if}
{/if}
</div>
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OTHER_PHONE' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_ENTERED' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{assign var="value" value=20-11-2019 }
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FAX_PHONE' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_MODIFIED' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DO_NOT_CALL' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_ADDRESS' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ALT_ADDRESS_STREET' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='scrm_Warehouse_Person'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
