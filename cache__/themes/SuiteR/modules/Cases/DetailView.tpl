...
{if strlen($fields.closedate_c.value) <= 0}
{assign var="value" value=$fields.closedate_c.default_value }
{else}
{assign var="value" value=$fields.closedate_c.value }
{/if} 
<span class="sugar_field" id="{$fields.closedate_c.name}">{$fields.closedate_c.value}</span>
{/if}
</div>
</div>
</div>
