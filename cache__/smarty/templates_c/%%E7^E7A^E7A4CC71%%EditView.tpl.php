...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['dutyfree_c']['value'] ) && $this->_tpl_vars['fields']['dutyfree_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['dutyfree_c']['options'],'selected' => $this->_tpl_vars['fields']['dutyfree_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['dutyfree_c']['options'],'selected' => $this->_tpl_vars['fields']['dutyfree_c']['default']), $this);?>
...
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['dutyfree_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['dutyfree_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['dutyfree_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['dutyfree_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['dutyfree_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['dutyfree_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['unregistered_user_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['unregistered_user_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['unregistered_user_c']['name']; ?>
" 
...
<?php if (strlen ( $this->_tpl_vars['fields']['cess_amount_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['cess_amount_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['cess_amount_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['cess_amount_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['cess_amount_c']['name']; ?>
' size='30' maxlength='26' value='<?php echo smarty_function_sugar_number_format(array('var' => $this->_tpl_vars['value']), $this);?>
' title='' tabindex='0'
>
</tr>
...
addToValidate(\'EditView\', \'unregistered_user_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_UNREGISTERED_USER','module' => 'quote_Quote','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'cess_amount_c\', \'currency\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CESS_AMOUNT','module' => 'quote_Quote','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'dutyfree_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DUTYFREE','module' => 'quote_Quote','for_js' => true), $this); echo '\' );
