<?php /* Smarty version 2.6.29, created on 2019-11-20 10:52:06
         compiled from cache/themes/SuiteR/modules/scrm_ScheduleHistory/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/scrm_ScheduleHistory/SearchForm_basic.tpl', 34, false),array('function', 'math', 'cache/themes/SuiteR/modules/scrm_ScheduleHistory/SearchForm_basic.tpl', 35, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/scrm_ScheduleHistory/SearchForm_basic.tpl', 44, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/scrm_ScheduleHistory/SearchForm_basic.tpl', 118, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/scrm_ScheduleHistory/SearchForm_basic.tpl', 89, false),)), $this); ?>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='1%' >
                        <label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'scrm_ScheduleHistory'), $this);?>
...
' title=''      accesskey='9'  >
        ...
        <td scope="row" nowrap="nowrap" width='1%' >
            ...
            <label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'scrm_ScheduleHistory'), $this);?>
</label>
                    </td>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_createdby_c_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["createdby_c_basic","user_id_c_basic"],"required_list":["user_id_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_cases_scrm_schedulehistory_1_name_basic\']={"form":"search_form","method":"query","modules":["Cases"],"group":"or","field_list":["name","id"],"populate_list":["cases_scrm_schedulehistory_1_name_basic","cases_scrm_schedulehistory_1cases_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_supervisor_c_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["supervisor_c_basic","user_id1_c_basic"],"required_list":["user_id1_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>