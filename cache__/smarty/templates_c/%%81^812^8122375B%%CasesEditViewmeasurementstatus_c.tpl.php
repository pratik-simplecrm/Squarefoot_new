<?php /* Smarty version 2.6.29, created on 2019-11-20 15:02:52
         compiled from cache/modules/AOW_WorkFlow/CasesEditViewmeasurementstatus_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/AOW_WorkFlow/CasesEditViewmeasurementstatus_c.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/CasesEditViewmeasurementstatus_c.tpl', 43, false),array('modifier', 'lookup', 'cache/modules/AOW_WorkFlow/CasesEditViewmeasurementstatus_c.tpl', 38, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/CasesEditViewmeasurementstatus_c.tpl', 143, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
	<select name="<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
" 
	id="<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
" 
	title=''  tabindex="1"       
	>

	<?php if (isset ( $this->_tpl_vars['fields']['measurementstatus_c']['value'] ) && $this->_tpl_vars['fields']['measurementstatus_c']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['measurementstatus_c']['options'],'selected' => $this->_tpl_vars['fields']['measurementstatus_c']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['measurementstatus_c']['options'],'selected' => $this->_tpl_vars['fields']['measurementstatus_c']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['measurementstatus_c']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['measurementstatus_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['measurementstatus_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>

			<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
" 
		id="<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
" 
		title=''  tabindex="1"          
	...
	<input
		id="<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-input"
		name="<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-input"
		size="30"
...
-image"></button><button type="button"
	        id="btn-clear-<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-input"
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
...
"></button>
	...
	'; ?>
			...
			<?php echo '
		(function (){
			var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['measurementstatus_c']['name'];  echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
');
			...
			//global variable 
			sync_';  echo $this->_tpl_vars['fields']['measurementstatus_c']['name'];  echo ' = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['measurementstatus_c']['name']; ?>
-input<?php echo '\'))
						SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['measurementstatus_c']['name'];  echo '", syncFromHiddenToWidget);
		'; ?>
