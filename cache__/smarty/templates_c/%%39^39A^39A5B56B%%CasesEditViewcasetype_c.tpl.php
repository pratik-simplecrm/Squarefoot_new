<?php /* Smarty version 2.6.29, created on 2019-11-20 17:45:39
         compiled from cache/modules/AOW_WorkFlow/CasesEditViewcasetype_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/AOW_WorkFlow/CasesEditViewcasetype_c.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/CasesEditViewcasetype_c.tpl', 43, false),array('modifier', 'lookup', 'cache/modules/AOW_WorkFlow/CasesEditViewcasetype_c.tpl', 38, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/CasesEditViewcasetype_c.tpl', 143, false),)), $this); ?>
...
" 
	...
	<?php if (isset ( $this->_tpl_vars['fields']['casetype_c']['value'] ) && $this->_tpl_vars['fields']['casetype_c']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['casetype_c']['options'],'selected' => $this->_tpl_vars['fields']['casetype_c']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['casetype_c']['options'],'selected' => $this->_tpl_vars['fields']['casetype_c']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['casetype_c']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['casetype_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['casetype_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
