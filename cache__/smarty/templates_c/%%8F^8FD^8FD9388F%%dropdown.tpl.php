<?php /* Smarty version 2.6.29, created on 2019-11-20 15:29:16
...
", true)'>
			...
			<script>
				$(function(){
					$(\'.editImage\').html(';  echo $this->_tpl_vars['editImage'];  echo ');
				});
			</script>
			'; ?>
...
SimpleList.init(';  echo $this->_tpl_vars['editImage'];  echo ', '; ?>
'<?php echo $this->_tpl_vars['deleteImage']; ?>
'<?php echo ');
