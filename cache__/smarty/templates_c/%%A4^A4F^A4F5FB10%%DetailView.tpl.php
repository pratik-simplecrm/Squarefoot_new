...
.value}_<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo smarty_function_sugarvar(array('key' => 'name'), $this); else:  echo $this->_tpl_vars['displayParams']['idName'];  endif; ?>{$fields.width.value}&type=<?php echo $this->_tpl_vars['vardef']['linkModule']; ?>
