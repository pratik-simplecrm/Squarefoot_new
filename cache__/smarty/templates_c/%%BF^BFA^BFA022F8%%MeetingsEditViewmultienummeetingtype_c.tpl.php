<?php /* Smarty version 2.6.29, created on 2019-11-20 17:43:55
         compiled from cache/modules/AOW_WorkFlow/MeetingsEditViewmultienummeetingtype_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'multienum_to_array', 'cache/modules/AOW_WorkFlow/MeetingsEditViewmultienummeetingtype_c.tpl', 7, false),array('function', 'html_options', 'cache/modules/AOW_WorkFlow/MeetingsEditViewmultienummeetingtype_c.tpl', 12, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/MeetingsEditViewmultienummeetingtype_c.tpl', 41, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/MeetingsEditViewmultienummeetingtype_c.tpl', 79, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>

	<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
_multiselect"
	name="<?php echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
_multiselect" value="true">
	<?php echo smarty_function_multienum_to_array(array('string' => $this->_tpl_vars['fields']['meetingtype_c']['value'],'default' => $this->_tpl_vars['fields']['meetingtype_c']['default'],'assign' => 'values'), $this);?>

	<select id="<?php echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
"
	name="<?php echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
[]"
	multiple="true" size='6' style="width:150" title='' tabindex="1"  
     	>
	<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['meetingtype_c']['options'],'selected' => $this->_tpl_vars['values']), $this);?>

	</select>

<?php else: ?>

	<?php $this->assign('field_options', $this->_tpl_vars['fields']['meetingtype_c']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['meetingtype_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['meetingtype_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
...
_multiselect" value="true">
		...
		<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
"
		name="<?php echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
[]"
		multiple="true" size='6' style="width:150" title='' tabindex="1"  
...
.minQLen<?php echo ' == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("';  echo $this->_tpl_vars['fields']['meetingtype_c']['name']; ?>
-input<?php echo '"))
