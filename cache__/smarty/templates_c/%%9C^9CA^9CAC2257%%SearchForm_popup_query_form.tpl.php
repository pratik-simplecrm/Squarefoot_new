...
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"quote_product_category_quote_productsquote_product_category_ida_advanced","name":"quote_product_category_quote_products_name_advanced"}}'; ?>
...
<?php echo smarty_function_html_options(array('id' => 'tax_class_c_advanced','name' => 'tax_class_c_advanced[]','options' => $this->_tpl_vars['fields']['tax_class_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['tax_class_c_advanced']['value']), $this);?>
...
<?php echo smarty_function_html_options(array('id' => 'uom_c_advanced','name' => 'uom_c_advanced[]','options' => $this->_tpl_vars['fields']['uom_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['uom_c_advanced']['value']), $this);?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='is_dutyfree_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_IS_DUTYFREE','module' => 'quote_Products'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['is_dutyfree_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['is_dutyfree_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['is_dutyfree_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['is_dutyfree_c_advanced']['name']; ?>
"   >
