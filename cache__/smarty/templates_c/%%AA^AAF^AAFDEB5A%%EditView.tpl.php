...
'></script>
<?php ob_start();  echo smarty_function_sugarvar(array('key' => 'name'), $this); $this->_smarty_vars['capture']['idName'] = ob_get_contents();  $this->assign('idName', ob_get_contents());ob_end_clean();  if (! empty ( $this->_tpl_vars['displayParams']['idName'] )):  $this->assign('idName', $this->_tpl_vars['displayParams']['idName']);  endif; ?>
...
.value}_<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo smarty_function_sugarvar(array('key' => 'name'), $this); else:  echo $this->_tpl_vars['displayParams']['idName'];  endif; ?>&type=<?php echo $this->_tpl_vars['vardef']['linkModule']; ?>
