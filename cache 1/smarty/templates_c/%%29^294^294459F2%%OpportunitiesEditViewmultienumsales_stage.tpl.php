<?php /* Smarty version 2.6.29, created on 2019-11-29 13:06:52
         compiled from cache/modules/AOW_WorkFlow/OpportunitiesEditViewmultienumsales_stage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'multienum_to_array', 'cache/modules/AOW_WorkFlow/OpportunitiesEditViewmultienumsales_stage.tpl', 7, false),array('function', 'html_options', 'cache/modules/AOW_WorkFlow/OpportunitiesEditViewmultienumsales_stage.tpl', 12, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/OpportunitiesEditViewmultienumsales_stage.tpl', 41, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/OpportunitiesEditViewmultienumsales_stage.tpl', 79, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>

	<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
_multiselect"
	name="<?php echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
_multiselect" value="true">
	<?php echo smarty_function_multienum_to_array(array('string' => $this->_tpl_vars['fields']['sales_stage']['value'],'default' => $this->_tpl_vars['fields']['sales_stage']['default'],'assign' => 'values'), $this);?>

	<select id="<?php echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
"
	name="<?php echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
[]"
	multiple="true" size='6' style="width:150" title='' tabindex="1"  
     	>
	<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['sales_stage']['options'],'selected' => $this->_tpl_vars['values']), $this);?>
...
_multiselect" value="true">
		...
		<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
"
		name="<?php echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
[]"
		multiple="true" size='6' style="width:150" title='' tabindex="1"  
...
.minQLen<?php echo ' == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("';  echo $this->_tpl_vars['fields']['sales_stage']['name']; ?>
-input<?php echo '"))
