<?php 
 $GLOBALS["dictionary"]["scrm_Warehouse_Person"]=array (
  'table' => 'scrm_warehouse_person',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_warehouse_person_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_warehouse_person_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_warehouse_person_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_scrm_warehouse_person',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_warehouse_person_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_warehouse_person_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'scrm_Warehouse_Personregionname_c',
      'custom_module' => 'scrm_Warehouse_Person',
    ),
    'branch_c' => 
    array (
      'inline_edit' => '1',
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'scrm_Warehouse_Personbranch_c',
      'custom_module' => 'scrm_Warehouse_Person',
    ),
  ),
  'relationships' => 
