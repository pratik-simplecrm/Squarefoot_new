<?php /* Smarty version 2.6.29, created on 2020-02-06 12:31:02
        ...
        if (typeof columnsFilter == \'undefined\') {
            ...
            var columnsFilter = {
                ...
                isValid: function () {
                    ...
                    if (!v) {
                        // show error
                        $(\'#error-displayed-columns\').html(\'';  echo $this->_tpl_vars['APP']['ERR_EMPTY_COLUMNS_LIST'];  echo '\');
...
'; ?>
    ...
    <?php $this->assign('columnsFilterDialogAdded', 'true');  endif; ?>