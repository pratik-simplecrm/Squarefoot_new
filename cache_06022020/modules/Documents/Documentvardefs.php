<?php 
 $GLOBALS["dictionary"]["Document"]=array (
  ...
  array (
    ...
    'documentsrelatedto_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Documents Related to',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'documentsrelatedto_c',
      'vname' => 'LBL_DOCUMENTSRELATEDTO',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Documentsdocumentsrelatedto_c',
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'documenttype_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => 'documentsrelatedto_c',
      'id' => 'Documentsdocumenttype_c',
      'custom_module' => 'Documents',
    ),
  ),
  'indices' => 
