<?php 
 $GLOBALS["dictionary"]["Case"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'documents uploaded',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'doc_uploaded_c',
      'vname' => 'LBL_DOC_UPLOADED',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'doc_uploaded_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Casesdoc_uploaded_c',
      'custom_module' => 'Cases',
    ),
    ...
    array (
      ...
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'scrm_accounts_id_c',
      'vname' => 'LBL_ACCOUNTS_SCRM_ACCOUNTS_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    'scrm_accountsteam_id_c' => 
    array (
      'inline_edit' => 1,
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'scrm_accountsteam_id_c',
      'vname' => 'LBL_ACCOUNTSTEAM_SCRM_ACCOUNTSTEAM_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Casesscrm_accountsteam_id_c',
      'custom_module' => 'Cases',
    ),
    'accountsteam_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Accounts Team',
      'required' => false,
      'source' => 'non-db',
      'name' => 'accountsteam_c',
      'vname' => 'LBL_ACCOUNTSTEAM',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'scrm_accountsteam_id_c',
      'ext2' => 'scrm_accountsteam',
      'module' => 'scrm_accountsteam',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Casesaccountsteam_c',
      'custom_module' => 'Cases',
    ),
    'scrm_accountperson_id_c' => 
    array (
      'inline_edit' => 1,
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'scrm_accountperson_id_c',
      'vname' => 'LBL_ACCOUNTPERSON_SCRM_ACCOUNTPERSON_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Casesscrm_accountperson_id_c',
      'custom_module' => 'Cases',
    ),
    'accountperson_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Account Person',
      'required' => false,
      'source' => 'non-db',
      'name' => 'accountperson_c',
      'vname' => 'LBL_ACCOUNTPERSON',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'scrm_accountperson_id_c',
      'ext2' => 'scrm_accountperson',
      'module' => 'scrm_accountperson',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Casesaccountperson_c',
      'custom_module' => 'Cases',
    ),
    'installationcompleteddate_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Installation completed date',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'installationcompleteddate_c',
      'vname' => 'LBL_INSTALLATIONCOMPLETEDDATE',
      'type' => 'datetimecombo',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'dbType' => 'datetime',
      'id' => 'Casesinstallationcompleteddate_c',
      'custom_module' => 'Cases',
    ),
    'materialreturndescription_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Material return description',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'materialreturndescription_c',
      'vname' => 'LBL_MATERIALRETURNDESCRIPTION',
      'type' => 'text',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'rows' => '4',
      'cols' => '40',
      'id' => 'Casesmaterialreturndescription_c',
      'custom_module' => 'Cases',
    ),
    'jjwg_maps_address_c' => 
    array (
