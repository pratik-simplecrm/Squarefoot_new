...
class ListViewDisplay {
	...
	function buildSelectLink($id = 'select_link', $total=0, $pageTotal=0, $location="top") {
		...
		$close_inline_img = SugarThemeRegistry::current()->getImage('close_inline', 'border=0', null, null, ".gif", $app_strings['LBL_CLOSEINLINE']);
                /*Modified By Roshan Sarode for List View Select Counts*/
		$selectObjectSpan = $this->buildSelectedObjectsSpan(true, (isset($_POST['mass'])) ? count($_POST['mass']): 0);
                        /*Modified By Roshan Sarode for List View Select Counts End*/
		$menuItems = array(
       ...
       /*List view edit delete gear icon*/
