	...
	<div class="col-xs-12 email-address-lines-container">
		...
		<div class="col-xs-12 template email-address-line-container hidden">
			<div class="col-xs-12 col-sm-6  email-address-input-container {if $module == "Users"} email-address-users-profile{/if}">
				<div class="email-address-input-group" style="height:auto">
                                    <input type="email" id="email-address-input" value="" class="form-control" placeholder="email@example.com" title="{$app_strings.LBL_EMAIL_TITLE}" style="width:80%;float:left">
					...
					<span  >
					<button type="button" id="email-address-remove-button" class="btn btn-danger email-address-remove-button" name="" title="{$app_strings.LBL_ID_FF_REMOVE}" type="button" style="width:15%">
