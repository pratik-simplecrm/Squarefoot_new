...
function smarty_function_sugar_button($params, &$smarty)
{
   ...
   if(!is_array($type)) {
   	  ...
   	  switch(strtoupper($type)) {
			case "SEARCH":
                $output = '<button tabindex="2" title="{$APP.LBL_SEARCH_BUTTON_TITLE}" onclick="SUGAR.savedViews.setChooser();" class="btn btn-outline-primary" type="submit" name="button" id="search_form_submit"/><i class="fa fa-search btn-color-new" aria-hidden="true" ></i></button>';
