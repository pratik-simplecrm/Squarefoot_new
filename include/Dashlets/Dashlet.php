...
class Dashlet
{
    ...
    public function setConfigureIcon()
    {
        if($this->isConfigurable) {
            ...
            //     . '';
                 ...
                 $additionalTitle = '<td nowrap width="1%" style="padding-right: 0px;"><div class="dashletToolSet"><a class="dashlet-edit-pencil" href="javascript:void(0)" onclick="openbacktab($(this)),SUGAR.mySugar.configureDashlet(\''
                . $this->id . '\'); return false;">'
    ...
    public function getHeader($text = '')
    {
        ...
        $str .= 'id="dashlet_header_' . $this->id . '" class="hd"><div class="tl"></div><div class="hd-center">' . get_form_header($this->title, $title, false,$this->seedBean->module_name) . '</div><div class="tr"></div></div><div class="bd"><div class="ml"></div><div class="bd-center">';
