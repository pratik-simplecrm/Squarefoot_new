...
<input class="date_input" autocomplete="off" type="text" name="{$fields.original_p_o_date_c.name}" id="{$fields.original_p_o_date_c.name}" value="{$date_value}" title=''  tabindex='1'    size="11" maxlength="10" >
