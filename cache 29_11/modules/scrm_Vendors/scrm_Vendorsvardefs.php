<?php 
 $GLOBALS["dictionary"]["scrm_Vendors"]=array (
  'table' => 'scrm_vendors',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendors_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendors_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendors_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_scrm_vendors',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendors_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_vendors_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'scrm_Vendorsbranch_c',
      'custom_module' => 'scrm_Vendors',
    ),
  ),
  'relationships' => 
  array (
