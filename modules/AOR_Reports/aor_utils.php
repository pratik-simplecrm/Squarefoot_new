...
function getPeriodDate($date_time_period_list_selected) {
    ...
    if ($date_time_period_list_selected == 'today') {
        ...
        $datetime_period = new DateTime('last day of previous month');
    ...
    $datetime_period = $datetime_period->setTime(18, 29, 59);
    //print_r($datetime_period);
...
function getPeriodEndDate($dateTimePeriodListSelected) {
    switch ($dateTimePeriodListSelected) {
        ...
        case 'this_month':
            ...
            $datetimePeriod->setTime(18, 29, 59);
            break;
        case 'last_month':
