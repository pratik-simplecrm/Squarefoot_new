        ...
        <table width="400" cellpadding="0" cellspacing="0" border="0" class="edit view" align="center">
            <tr>
                ...
                <td valign='top' class='dataField'>
                    <input type="text" value="{$dashlet_title}" size="30" name="obmdmtwrt_dashlet_title"/>
                </td>
            </tr>
            <tr>
                <td valign='top' nowrap class='dataLabel'>{$LBL_DATE_START} <br><i>{$user_date_format}</i></td>
                <td valign='top' class='dataField'>
                    <input onblur="parseDate(this, '{$cal_dateformat}');" type="text" class="text" name="obmdmtwrt_date_start" size='12' maxlength='10' id='date_start' value='{$date_start}'>
            ...
            <tr>
                ...
                <td valign='top' class='dataField'>
                    <input onblur="parseDate(this, '{$cal_dateformat}');" type="text" class="text" name="obmdmtwrt_date_end" size='12' maxlength='10' id='date_end' value='{$date_end}'>
            ...
            <tr>
                ...
                <td valign='top' class='dataField'>
                    <select name="obmdmtwrt_ids[]" multiple size='3'>
                        {$obmdmtwrt_ids}
                    </select>
                </td>
            </tr>
             <tr>
                <td valign='top' nowrap class='dataLabel'>Team Name</td>
                <td valign='top' class='dataField'>
                    <select name="obmdmtwrt_team_name[]" multiple size='3'>
                        <option></option>
                    </select>
                </td>
            </tr>
