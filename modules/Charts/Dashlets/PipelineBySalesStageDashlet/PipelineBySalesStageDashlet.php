...
//Google chart added by Roshan Sarode start
...
//        $endDate = $this->pbss_date_end;
        //Google chart added by Roshan Sarode end
...
function drawChart() {
    ...
    var chart = new google.visualization.BarChart(document.querySelector('#chart_div$canvasId'));
...
google.load('visualization', '1', {packages:['corechart'], callback: drawChart});
    ...
    <div id="chart_div$canvasId" class="google_chart"></div><br>
