 ...
 * PLACE ANY CUSTOMIZATIONS IN Arch_Architectural_Firm
 */

require_once('include/SugarObjects/templates/company/Company.php');

class Arch_Architectural_Firm_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'Arch_Architectural_Firm';
	var $object_name = 'Arch_Architectural_Firm';
	var $table_name = 'arch_architectural_firm';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $arch_architectural_firm_type;
		var $industry;
		var $annual_revenue;
		var $phone_fax;
		...
		var $others;
		var $archi;
		function Arch_Architectural_Firm_sugar(){	
		parent::Company();
	}
