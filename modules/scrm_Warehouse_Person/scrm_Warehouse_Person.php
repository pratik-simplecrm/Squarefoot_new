...
class scrm_Warehouse_Person extends Person
{
    public $new_schema = true;
    public $module_dir = 'scrm_Warehouse_Person';
    public $object_name = 'scrm_Warehouse_Person';
    public $table_name = 'scrm_warehouse_person';
