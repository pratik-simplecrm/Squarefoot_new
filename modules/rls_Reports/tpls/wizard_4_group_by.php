    ...
    <div class="rls_wizard_left">
        <div class="rls_wizard_left_box">
          ...
          <div class="rls_wizard_left_container">
              <div id="groupby-modules-tree"></div>
        ...
        <div class="rls_wizard_left_box">
            <div class=rls_wizard_left_header>
                <h3 class="h3Row">
                    ...
                    <input id="groupby_fields_of_module-search_field" size="12" onkeyup="Wizard.Fields.setFilter(this.value, 'groupby_fields_of_module')">
                    <input type="button" value="X" onclick="Wizard.Fields.resetFilter('groupby_fields_of_module')">
                </h3>
            </div>
            <div class=rls_wizard_left_container>
                <table class="" cellpadding="0" cellspacing="0">
                    <tbody id="groupby_fields_of_module">
