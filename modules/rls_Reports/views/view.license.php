...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_REPORTLICENSEADDON','Administration').': '.translate('LBL_REPORTLICENSEADDON_LICENSE_TITLE','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        $this->ss->assign("rls_manage_licensed_users", false);
        if(!empty($sugar_config['outfitters_licenses']) && !empty($sugar_config['outfitters_licenses'][$outfitters_config['shortname']])) {
            ...
            //If key from RLS
            $this->ss->assign("rls_manage_licensed_users", (strlen($sugar_config['outfitters_licenses'][$outfitters_config['shortname']]) == 35));
        }
