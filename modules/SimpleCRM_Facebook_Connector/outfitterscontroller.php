...
if($_REQUEST['method'] == 'validate') {
    ...
    //Sugar 6: /index.php?module=SimpleCRM_Facebook_Connector&action=outfitterscontroller&method=test&to_pdf=1
    //Sugar 7: #bwc/index.php?module=SimpleCRM_Facebook_Connector&action=outfitterscontroller&method=test&to_pdf=1
