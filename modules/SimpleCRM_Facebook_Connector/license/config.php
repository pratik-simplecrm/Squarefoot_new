...
$outfitters_config = array(
    'name' => 'SimpleCRM_Facebook_Connector', //The matches the id value in your manifest file. This allow the library to lookup addon version from upgrade_history, so you can see what version of addon your customers are using
    'shortname' => 'sugarcrm-facebook-listener', //The short name of the Add-on. e.g. For the url https://www.sugaroutfitters.com/addons/sugaroutfitters the shortname would be sugaroutfitters
    'public_key' => 'fe1841ec2728248ac7a70c0ad579857d', //The public key associated with the group
