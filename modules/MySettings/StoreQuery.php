...
class StoreQuery
{
    ...
    {
        $this->query['searchFormTab']='advanced_search';
        //$GLOBALS['log']->fatal(print_r($this->query,true),"Save Query final");
...
//To Resolve date issue in advanced search start Changed by: Roshan Sarode
...
//                            } else 
                            //To Resolve date issue in advanced search end Changed by: Roshan Sarode
