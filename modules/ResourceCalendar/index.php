...
?>
<?php
//Link is not woking issue start Changes by Roshan Sarode
//header("Location:index.php?module=Project&action=ResourceList&parentTab=All&ajax_load=1&loadLanguageJS=1");
//die('--');

header("Location:index.php?module=Project&action=ResourceList");
die('--');
//Link is not woking issue end Changes by Roshan Sarode
