 ...
 * PLACE ANY CUSTOMIZATIONS IN Arch_Architects_Contacts
 */

require_once('include/SugarObjects/templates/person/Person.php');

class Arch_Architects_Contacts_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'Arch_Architects_Contacts';
	var $object_name = 'Arch_Architects_Contacts';
	var $table_name = 'arch_architects_contacts';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $archi_type;
		var $business_potential;
		var $educational_institutional;
		var $pharmaceutical;
		var $hotels;
		var $sports;
		var $residential;
		...
		var $retail;
		var $others;
		function Arch_Architects_Contacts_sugar(){	
		parent::Person();
	}
