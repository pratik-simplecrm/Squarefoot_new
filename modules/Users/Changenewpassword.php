...
$sugar_smarty->assign("LBL_USER_NAME", $mod_strings['LBL_USER_NAME']);
$sugar_smarty->assign("USERNAME_FIELD", '<input required="required" type="text" id="user_name" name="user_name"  value="" placeholder="'.$mod_strings['LBL_USER_NAME'].'" />');
...
$sugar_smarty->assign('SUBMIT_BUTTON','<input title="'.$mod_strings['LBL_LOGIN_BUTTON_TITLE']
	...
	. 'type="button" tabindex="3" id="login_button" name="Login" value="'.strtoupper($mod_strings['LBL_LOGIN_BUTTON_LABEL']).'" /><br>&nbsp');
