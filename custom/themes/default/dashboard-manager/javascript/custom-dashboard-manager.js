		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "index.php?entryPoint=server_processing",
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "index.php?entryPoint=server_users_processing",
	...
	$("#posts_content").on("click",".view-dashboard-button",function(){
		var id=(this.id);
		$.ajax({
			url: "index.php?entryPoint=dashboard-manager-responce",
			type: "post",
...
$("#view_securitygrouplist").on("change",".securitygroup_checkbox",function(){ //".checkbox" change
    ...
    $("#view_aclroleuserlist").show();
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "index.php?entryPoint=server_roles_users_processing",
		"fnServerParams": function ( aoData ) {
...
*/
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "index.php?entryPoint=server_teams_users_processing",
				"fnServerParams": function ( aoData ) {
