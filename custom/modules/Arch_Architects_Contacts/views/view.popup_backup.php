...
class Arch_Architects_ContactsViewPopup extends SugarView{
    protected $override_popup = array();
	var $type ='list';
	function Arch_Architects_ContactsViewPopup(){
		parent::SugarView();
	}
	...
	function display(){
		...
		/**
		 * Purpose: To autosubmit the search form in pop view
		 * Author: Hatim Alam
		 * Dated: 07-07-2014
		 */
		if(isset($_GET['arch_archieaacal_firm_ida_advanced'])) {
			echo $js = <<<BOC
