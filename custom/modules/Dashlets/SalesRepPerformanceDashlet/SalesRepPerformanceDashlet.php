...
class SalesRepPerformanceDashlet extends DashletGenericChart
{
    ...
    public function display()
    {
        ...
        $data = $this->getChartData($this->constructQuery($login_user_id,$curYear));
...
EOD;
     ...
     */
    protected function constructQuery($login_user_id,$curYear)
    {
...
WHERE US.users_sf_sales_forecast_1users_ida='".$login_user_id."'  AND S.year='".$curYear."' AND S.deleted=0 AND US.deleted=0 LIMIT 1";
