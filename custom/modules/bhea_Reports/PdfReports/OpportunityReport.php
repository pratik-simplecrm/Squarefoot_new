                             ...
                             if (!empty($user_roles[0])) {
                                    foreach ($user_roles[0] as $k => $v) {
                                        if ($v == 'Regional Manager') {
                                          $report_user_role='Regional Manager'; 
                                          $users=$this->get_reportsTo_id('b4357f32-4d34-fda8-047f-4e1ef90d7d83');
...
EOD;
 ...
 function get_reportsTo_id($user_id){
     //Function to get the reporting user 
    global $db;
    $array_id=[];
 ...
 //This function used to get the active users
    global $db;
    $active_array_id=[];
    //$i=0;
