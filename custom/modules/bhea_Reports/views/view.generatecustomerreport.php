...
class bhea_ReportsViewgeneratecustomerreport extends SugarView{
    ...
    function display()
	{
        ...
        if($_REQUEST['Export_Chart'])
        {
           ...
           /* CAT:Bar Chart */
            ...
            $pdf->SetAuthor('BHEA');
             $report_name =  "Customer Report By ".$_REQUEST['group_by'][0];
...
HTML_Data_header;
        ...
        function setPageBack(index)
        {
            ...
            {
                $('#imageLoading').css('display','block');
                url =  "index.php?module=bhea_Reports&action=AjaxDataCustomer&to_pdf=1&curr_index="+index; 
            ...
            else
            {
                ...
                if(curr_index > 50) {
                    ...
                    url =  "index.php?module=bhea_Reports&action=AjaxDataCustomer&to_pdf=1&curr_index="+(parseInt(prev_index)+1);
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: datastring,
		...
		function setPage(index)
		{
            ...
            if(index == 'end') 
            {
                ...
                url =  "index.php?module=bhea_Reports&action=AjaxDataCustomer&to_pdf=1&curr_index="+curr_index; 
...
JS;
		...
		if(!empty($_REQUEST['Export']))
		{
			...
			fputcsv($output, array('Customer Name', 'Customer Type','Office Phone','Email Address','Website','Billing City','Assigned to','Team'));
