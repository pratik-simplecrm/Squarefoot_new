...
class bhea_ReportsViewsystemloginlog extends SugarView{
...
D;
        ...
        <div id="mainBody">
            ...
            <tr>
            <td><input type="submit" id="Run_Report" name="Run_Report" value="Run Report" />&nbsp;&nbsp;&nbsp;<button id="clear" > Clear</button>&nbsp;&nbsp;<input type="submit" id="Export" name="Export" value="Export" /></td>
            </tr>
            </table>
            </form>
            </div>
...
HTML_Data_header;
        ...
        function setPageBack(index)
        {
            ...
            {
                $('#imageLoading').css('display','block');
                url =  "index.php?module=bhea_Reports&action=AjaxDataSystemLoginLog&to_pdf=1&curr_index="+index; 
