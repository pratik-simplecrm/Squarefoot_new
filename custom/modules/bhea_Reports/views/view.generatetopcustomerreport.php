...
class bhea_ReportsViewgeneratetopcustomerreport extends SugarView{
    ...
    function getChartData($post)
    {
       ...
       if ($group_by == 'Assigned User'){
         ...
         $queryChart = " SELECT
            $group_by_query , count(A.id) as total
    ...
    function display()
	{
        ...
        if($_REQUEST['Export_Chart'])
        {
           ...
           /* CAT:Bar Chart */
            ...
            $pdf->SetAuthor('BHEA');
            $report_name =  "Top 10 Customers In Revenue Report By ".$_REQUEST['group_by'][0];
...
D;
		...
		$report_name = "Top 10 Customers In Revenue";
...
HTML_Search;
		...
		<div id="mainData">
			...
			<tr  height="25">
			<th><label>Customer Name&nbsp;&nbsp;<img border="0" align="absmiddle" src="themes/default/images/arrow_down.gif"></lable></th>
			<th><label>Opportunity Amount</lable></th>
			<th><label>Billing City</lable></th>
			<th><label>Billing Country</lable></th>
...
HTML_Data_header;
        ...
        function setPageBack(index)
        {
            ...
            {
                $('#imageLoading').css('display','block');
                url =  "index.php?module=bhea_Reports&action=AjaxDataTopCustomer&to_pdf=1&curr_index="+index; 
            ...
            else
            {
                ...
                if(curr_index > 50) {
                    ...
                    url =  "index.php?module=bhea_Reports&action=AjaxDataTopCustomer&to_pdf=1&curr_index="+(parseInt(prev_index)+1);
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: datastring,
		...
		function setPage(index)
		{
            ...
            if(index == 'end') 
            {
                ...
                url =  "index.php?module=bhea_Reports&action=AjaxDataTopCustomer&to_pdf=1&curr_index="+curr_index; 
...
JS;
		...
		if(!empty($_REQUEST['Export']))
		{
			...
			header('Content-Disposition: attachment; filename=Top_10_Customers.csv');
