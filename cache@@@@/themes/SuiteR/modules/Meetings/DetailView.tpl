...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.accountname_c.hidden}
...
<span id="account_id_c" class="sugar_field" data-id-value="{$fields.account_id_c.value}">{$fields.accountname_c.value}</span>
...
<span id="user_id1_c" class="sugar_field" data-id-value="{$fields.user_id1_c.value}">{$fields.supervisor_c.value}</span>
{/if}
</div>
</div>
</div>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.opportunities_c.hidden}
...
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="opportunity_id_c" class="sugar_field" data-id-value="{$fields.opportunity_id_c.value}">{$fields.opportunities_c.value}</span>
...
<div class="" type="function" field="reminders"    style="font-size:14px;word-wrap: break-word;">
{if !$fields.reminders.hidden}
{counter name="panelFieldCount"}
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.flag_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_FLAG' module='Meetings'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
<div class="" type="enum" field="flag_c"    style="font-size:14px;word-wrap: break-word;">
{if !$fields.flag_c.hidden}
{counter name="panelFieldCount"}
