<?php /* Smarty version 2.6.29, created on 2019-12-10 07:36:07
         compiled from cache/themes/SuiteR/modules/Opportunities/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 205, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 215, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 258, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 699, false),array('function', 'sugar_number_format', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 775, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 1457, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 259, false),array('modifier', 'escape', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 1067, false),array('modifier', 'url2html', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 1067, false),array('modifier', 'nl2br', 'cache/themes/SuiteR/modules/Opportunities/DetailView.tpl', 1067, false),)), $this); ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['reasonforrschedule_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_REASONFORRSCHEDULE','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="" type="enum" field="reasonforrschedule_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['reasonforrschedule_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['reasonforrschedule_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['reasonforrschedule_c']['options'][$this->_tpl_vars['fields']['reasonforrschedule_c']['value']]; ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['triggerfield_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TRIGGERFIELD','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="" type="enum" field="triggerfield_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['triggerfield_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['triggerfield_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['triggerfield_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['triggerfield_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['triggerfield_c']['options'][$this->_tpl_vars['fields']['triggerfield_c']['value']]; ?>
...
<li class="active" id="remove_color_current_level_c"><span><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL1','module' => 'Opportunities'), $this);?>
