...
" 
	...
	<?php if (isset ( $this->_tpl_vars['fields']['flag_c']['value'] ) && $this->_tpl_vars['fields']['flag_c']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['flag_c']['options'],'selected' => $this->_tpl_vars['fields']['flag_c']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['flag_c']['options'],'selected' => $this->_tpl_vars['fields']['flag_c']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['flag_c']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['flag_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['flag_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
