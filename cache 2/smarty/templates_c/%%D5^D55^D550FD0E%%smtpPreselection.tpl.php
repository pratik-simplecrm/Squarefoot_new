...
<script type="text/javascript">
    ...
    function changeEmailScreenDisplay(smtptype, clear)
    {
        if(clear) {
            ...
            document.getElementById("password_change_label").innerHTML = \'';  echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPPASS'];  echo '\';
        ...
        switch (smtptype) {
            case "yahoomail":
                ...
                //document.getElementById("password_change_label").innerHTML =
                        document.getElementById("password_change_label").innerHTML = \'';  echo $this->_tpl_vars['MOD']['LBL_YAHOOMAIL_SMTPPASS'];  echo '\';
            ...
            case "gmail":
                ...
                //document.getElementById("mailsettings1").style.display = \'none\';
                //document.getElementById("mailsettings2").style.display = \'none\';
                document.getElementById("password_change_label").innerHTML = \'';  echo $this->_tpl_vars['MOD']['LBL_GMAIL_SMTPPASS'];  echo '\';
            ...
            case "exchange":
                ...
                document.getElementById("mailsettings1").style.display = \'\';
                document.getElementById("mailsettings2").style.display = \'\';
                document.getElementById("password_change_label").innerHTML = \'';  echo $this->_tpl_vars['MOD']['LBL_EXCHANGE_SMTPPASS'];  echo '\';
