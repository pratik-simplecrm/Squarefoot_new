...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.file_mime_type.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_FILE_MIME_TYPE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
{/if}
</span>
...
{/if} 
<span class="sugar_field" id="{$fields.file_mime_type.name}">{$fields.file_mime_type.value}</span>
{/if}
</div>
</div>
{counter name="fieldsUsed"}
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
{if !$fields.opportunities_scoring_c.hidden}
&nbsp;
{/if}
</span>
