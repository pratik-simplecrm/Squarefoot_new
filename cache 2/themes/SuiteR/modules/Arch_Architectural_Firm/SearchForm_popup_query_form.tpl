...
{html_options id='archi_advanced' name='archi_advanced[]' options=$fields.archi_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.archi_advanced.value}
                    </td>
